...
* 0-README, man, AUTHORS: Wrote the `README.md`, `man_1_simple_shell`, `AUTHORS` files
* 1-Betty would be proud: Write beautiful code that passes the Betty checks
* 2-Simple shell 0.1: Display prompt, handle simple single commands without arguments, handle errors & EOF condition
* 3-Simple shell 0.2: Handled command lines with arguments in `simple_shell`
4.Simple shell 0.3: Handle PATH
